...
namespace SIMEAD
{
    ...
    public class ApplicationSignInManager : SignInManager<ApplicationUser, string>
    {
        ...
        {
            string encriptedPassowrd = password;

            using (SIMEADEntities db = new SIMEADEntities())
            {
                aspnet_Membership user = await db.aspnet_Membership.FirstOrDefaultAsync(x => x.Email == userName && x.Password == encriptedPassowrd);
                if (user == null)
